...
function quieroComprar() {
    if (carrito.length <= 3) {
        ...
        if (productoElegido == "Jean") {
            ...
            descuentoDeJean()
            alert(`Estes producto se agrego con un 20% de descuento, entonces vale ${pantalonInquitaConDescuento}`)
            console.log(`${pantalonInquita.nombre} fue agregado al carrito`)
            seguirComprando()
        }
